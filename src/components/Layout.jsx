      ...
      <header className="md:hidden sticky top-0 z-30 bg-surface-card border-b border-outline-variant px-4 py-2.5 flex items-center justify-between shadow-card safe-top">
        ...
        <div className="flex items-center gap-1">
          ...
          {/* Chat con Asistente en móvil/app (18-ago-2026) — la barra inferior
              ...
              asignatura en particular. En azul y con animate-bounce (pedido
              explícito, 18-ago-2026) para que se note entre los demás
              íconos, que son grises — mismo animate-bounce que ya usa el
              proyecto (p. ej. SubjectPage.jsx al copiar código de acceso). */}
          <NavLink
            to="/chat-asistente"
            aria-label="Chat con Asistente"
            className="p-2 text-accent rounded transition-colors"
          >
