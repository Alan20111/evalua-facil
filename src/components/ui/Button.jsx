...
//
// `variant` vive en cva (API declarativa estándar, docs/PLAN_ACCESIBILIDAD_Y_ADAPTABILIDAD.md
// Fase 3, paso 3.2). `size` se queda en JS plano a propósito: no es un eje
// ortogonal — solo aplica a 4 de las 8 variantes (las "de texto"), y forzarlo
// dentro de cva pediría 12 compoundVariants para lo que hoy son 3 líneas.
//
// Props:
