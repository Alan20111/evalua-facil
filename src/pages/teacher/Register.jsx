          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded border text-sm text-left flex items-center justify-between gap-2 transition-colors disabled:opacity-50 ${
                  selectedPlantel
              ...
              <label className="flex items-center gap-2 mt-2 ml-1 cursor-pointer">
                ...
                />
                <span className="text-xs text-muted">Prefiero no elegir en este momento (podré asignarla luego en mi perfil)</span>
              </label>
            </div>
