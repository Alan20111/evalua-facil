// Pruebas de "Aplicar calificaciones de IA a todas" (functions/
// calificarAplicar.js). No llama a Anthropic ni al ledger de créditos —
...
const { aplicarEvaluacionesIAPendientesImpl, totalInstrumento } = calAp._pruebas
