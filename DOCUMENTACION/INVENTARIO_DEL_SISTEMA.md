...
>   (`public_id`+`timestamp`+secreto) y trata `not found` como éxito, que es lo
>   correcto para reintentos.
...
| A07 | Estudiantes e inscripciones | F2 | M06, M20 | Crítico | **Completada** | 5-ago-2026 | pendiente de merge |
